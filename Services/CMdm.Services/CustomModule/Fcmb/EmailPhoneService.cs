...
namespace CMdm.Services.CustomModule.Fcmb
{
    public class EmailPhoneService : IEmailPhoneService
    {
        ...
        public virtual IList<EmailPhone> GetEmailPhonebyIds(Int64[] recordIds)
        {
        ...
        /// <returns>Vendor</returns>
        public virtual EmailPhone GetEmailPhonebyId(Int64 recordId)
        {
            if (recordId == 0)
                return null;
        ...
        public virtual IPagedList<EmailPhone> GetAllEmailPhones(string custid = "", string accno = "",  string phone = "", string email = "", string firstname = "", string midname = "", string lastname = "",
            string branchCode = "", int pageIndex = 0, int pageSize = int.MaxValue, string sortExpression = "")
        {
            ...
            result = _emailPhoneDAC.SelectEmailPhone(custid, accno, phone, email, firstname, midname, lastname, branchCode, pageIndex, pageSize, sortExpression);
