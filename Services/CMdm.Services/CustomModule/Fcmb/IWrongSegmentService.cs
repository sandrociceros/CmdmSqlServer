...
namespace CMdm.Services.CustomModule.Fcmb
{
    public interface IWrongSegmentService
    {
        ...
        IList<WrongSegment> GetWrongSegmentbyIds(Int64[] recordIds);
        /// <summary>
        /// Gets a Queitem by item reference identifier
        /// </summary>
        /// <param name="recordId">que identifier</param>
        /// <returns>Vendor</returns>
        WrongSegment GetWrongSegbyId(Int64 recordId);
        /// <summary>
        /// Gets all items
        /// </summary>
        ...
        IPagedList<WrongSegment> GetAllWrongSegments(string custid = "", string accountno = "", string fname = "", string mname = "", string lname = "", string branchCode = "",
