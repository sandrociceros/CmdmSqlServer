...
namespace CMdm.Services.CustomModule.Fcmb
{
    public class WrongSegmentService : IWrongSegmentService
    {
        ...
        public virtual IPagedList<WrongSegment> GetAllWrongSegments(string custid = "", string accountno = "", string fname = "", string mname = "", string lname = "", string branchCode = "",
            int pageIndex = 0, int pageSize = int.MaxValue, string sortExpression = "")
        {
            ...
            result = _wsDAC.SelectWrongSegment(custid, accountno, fname, mname, lname, branchCode, pageIndex, pageSize, sortExpression);
